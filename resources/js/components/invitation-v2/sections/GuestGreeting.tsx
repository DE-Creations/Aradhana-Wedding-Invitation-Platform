  ...
  return (
    <section className="section-pad bg-charcoal" style={{ textAlign: 'center' }}>
      <AnimatedSection animation="blurIn" duration={1}>
        ...
        <h2 className="font-script" style={{ color: '#FAF7F2', fontSize: 'clamp(2.25rem, 6vw, 2.75rem)', margin: '0.5rem 0 1rem' }}>
          {name}
        </h2>
        <Flourish width={90} />
        <p
          className="font-body"
          style={{ color: '#E8D5A3', fontSize: '1.05rem', maxWidth: 540, margin: '1.25rem auto 0', lineHeight: 1.7 }}
        >
